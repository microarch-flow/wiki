...
你的主线是 AI tile dataflow NoC，但 CPU/cache coherent NoC 仍然很有参考价值。  
它最大的价值不在于让你照搬 CPU 设计，而在于让你看到：

- 为什么 request / response / snoop 必须隔离
- 为什么 VN / VC 在协议正确性里这么关键
- 为什么“能跑通”不等于“协议安全”
...
- 支撑共享地址空间
- 处理 cache miss
- 支撑 coherence transaction
- 保证 ordering、atomicity 和 forward progress
